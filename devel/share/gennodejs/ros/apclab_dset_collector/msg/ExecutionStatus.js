...
// (in-package apclab_dset_collector.msg)
...
class ExecutionStatus {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ExecutionStatus(null);
  ...
  static datatype() {
    ...
    return 'apclab_dset_collector/ExecutionStatus';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ExecutionStatus(null);
